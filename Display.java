...
public class Display extends JFrame {
  ...
  public Display() {
    ...
    final JLabel lblNearestneighbordistance = new JLabel("");
    ...
    final JLabel lblNearestneighbortime = new JLabel("");
    ...
    final JLabel lblBruteforcedistance = new JLabel("");
    ...
    final JLabel lblBruteforcetime = new JLabel("");
